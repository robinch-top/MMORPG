...
{
    public class PlayerSkills : Componet.SkillsComponet
    {
        public void Start()
        {
            // 暂时写死一份战士技能信息数据在此
        ...
        public void LoadPlayerSkills(SkillInfo[] datas)
        {
            ...
            foreach (ScriptableSkill skillData in skillTemplates)
                skills.Add(new Skill.Skill(skillData));
        }
        ...
        public void TryUse(int skillIndex, bool ignoreState = false)
        {
            ...
            {
                Skill.Skill skill = skills[skillIndex];
        ...
        public bool CanUpgrade(Skill.Skill skill)
        {
